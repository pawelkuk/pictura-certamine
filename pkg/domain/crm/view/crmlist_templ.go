...
func CRMList(arr []model.ContestantEntry, err error) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<form action=\"/auth/logout\" method=\"post\"><sl-button type=\"submit\" variant=\"primary\">Logout</sl-button></form><sl-button variant=\"neutral\" href=\"/crm/export\" target=\"_blank\">Download CSV</sl-button> ")
			if templ_7745c5c3_Err != nil {
			...
			if err != nil {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/domain/crm/view/crmlist.templ`, Line: 20, Col: 17}
				}
			...
			if len(arr) != 0 {
				...
				for _, item := range arr {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/domain/crm/view/crmlist.templ`, Line: 45, Col: 23}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/domain/crm/view/crmlist.templ`, Line: 46, Col: 27}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/domain/crm/view/crmlist.templ`, Line: 47, Col: 26}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/domain/crm/view/crmlist.templ`, Line: 48, Col: 29}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/domain/crm/view/crmlist.templ`, Line: 49, Col: 27}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/domain/crm/view/crmlist.templ`, Line: 50, Col: 24}
					}
					...
					for _, link := range item.ArtPieces {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/domain/crm/view/crmlist.templ`, Line: 80, Col: 95}
						}
